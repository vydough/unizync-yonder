...
insert into clubs (name, initials, university_id) values
  ...
  ('RUSU', 'RUSU', (select id from universities where short_name = 'RMIT')),
  ('Monash Student Association', 'MSA', (select id from universities where short_name = 'Monash'));
...
-- ---------- live catalogue snapshot (6 September 2026) ----------
-- These are real public event pages read through lib/event-parser. The
-- exact page_url is retained so the app never sends students to a provider
-- homepage. Refresh this block when the upstream listings change.

insert into events (club_id, title, description, image_url, starts_at, ends_at, venue_name, suburb, address,
                    lat, lng, price_cents, ticket_url, page_url, ticket_provider, activity_type_id) values
  ((select id from clubs where name = 'RUSU'),
   'RUSU & Just Food Collective Present: (Learn how to) Pickle Party!',
   'Learn how to pickle at Realfoods Canteen with RUSU and the Just Food Collective.',
   'https://images.humanitix.com/i/52668f17-2fd5-4bf3-8e25-aefa5550c8e8.jpg@seo-500.jpg',
   '2026-09-10 06:15:00+00', '2026-09-10 07:30:00+00', 'Realfoods Canteen', 'Melbourne',
   'Bldg 8, Level 3/360 Swanston St, Melbourne VIC 3000', -37.814, 144.963, 500,
   'https://events.humanitix.com/rusu-and-just-food-collective-present-learn-how-to-pickle-party/tickets',
   'https://events.humanitix.com/rusu-and-just-food-collective-present-learn-how-to-pickle-party', 'humanitix',
   (select id from activity_types where label = 'Workshops')),
  ((select id from clubs where name = 'RUSU'),
   'RUSU Sustainability Workshop Series',
   'A sustainability workshop series hosted by RUSU.',
   'https://images.humanitix.com/i/fcaa1eb0-f9a6-4a2e-94ac-64aace14b63c.png@seo-500.jpg',
   '2026-09-14 04:00:00+00', '2026-09-14 06:00:00+00', null, 'Melbourne', null,
   -37.814, 144.963, 0,
   'https://events.humanitix.com/rusu-sustainability-department-series/tickets',
   'https://events.humanitix.com/rusu-sustainability-department-series', 'humanitix',
   (select id from activity_types where label = 'Workshops')),
  ((select id from clubs where name = 'RUSU'),
   'Women''s Department Speed Friending Event',
   'Meet new people at RUSU Women''s Department speed friending.',
   'https://images.humanitix.com/i/7a08a31a-d796-4415-ad1e-b752445473c9.png@seo-500.jpg',
   '2026-09-15 02:00:00+00', '2026-09-15 04:00:00+00', 'Garden Building RMIT University LVL 6', 'Melbourne',
   'City campus, 124 La Trobe St, Melbourne VIC 3000', -37.814, 144.963, 500,
  'https://events.humanitix.com/women-s-department-speed-friending-event/tickets',
  'https://events.humanitix.com/women-s-department-speed-friending-event', 'humanitix',
   (select id from activity_types where label = 'Social mixers')),
  ((select id from clubs where name = 'RUSU'),
   'International Department Acrylic Painting Session',
   'An acrylic painting session hosted by the RUSU International Department.',
   'https://images.humanitix.com/i/d99f7d7a-9c7a-4625-b601-ec209223d7db.png@seo-500.jpg',
   '2026-09-15 03:30:00+00', '2026-09-15 05:30:00+00', 'RUSU Activity Space 10.3.59', 'Melbourne',
   'City campus, 124 La Trobe St, Melbourne VIC 3000', -37.814, 144.963, 500,
   'https://events.humanitix.com/international-department-does-painting/tickets',
   'https://events.humanitix.com/international-department-does-painting', 'humanitix',
   (select id from activity_types where label = 'Workshops')),
  ((select id from clubs where name = 'RUSU'),
   'Bundy Bash After Party',
   'The Bundy Bash after party at The Pulse, Bundoora campus.',
   'https://images.humanitix.com/i/664aa119-f62e-4e4a-aecb-2de148b8acdb.jpg@seo-500.jpg',
   '2026-09-16 06:00:00+00', '2026-09-16 09:00:00+00', 'Bld 204, The Pulse', 'Bundoora',
   'Bundoora campus, 225-245 Plenty Rd, Bundoora VIC 3082', -37.7, 145.067, 0,
   'https://events.humanitix.com/bundy-bash-after-party/tickets',
   'https://events.humanitix.com/bundy-bash-after-party', 'humanitix',
   (select id from activity_types where label = 'Social mixers')),
  ((select id from clubs where name = 'RUSU'),
   'Disability and Carers Coffee and Crafts',
   'Coffee and crafts at the RUSU Activity Space.',
   'https://images.humanitix.com/i/c4b1c701-7fc0-4c57-a7ea-6adee829b646.png@seo-500.jpg',
   '2026-09-17 00:30:00+00', '2026-09-17 01:30:00+00', 'RUSU Activity Space 10.3.59', 'Melbourne',
   'City campus, 124 La Trobe St, Melbourne VIC 3000', -37.814, 144.963, 0,
   'https://events.humanitix.com/disability-and-carers-coffee-and-crafts/tickets',
   'https://events.humanitix.com/disability-and-carers-coffee-and-crafts', 'humanitix',
   (select id from activity_types where label = 'Social mixers')),
  ((select id from clubs where name = 'RUSU'),
   'RUSU Members Drinks!!',
   'RUSU members drinks at The Oxford Scholar.',
   'https://images.humanitix.com/i/969f63d1-96f8-423c-9e1d-bafd3c4bb9da.png@seo-500.jpg',
   '2026-09-17 07:00:00+00', '2026-09-17 11:00:00+00', 'The Oxford Scholar - Back Bar', 'Melbourne',
   '427 Swanston St, Melbourne VIC 3000', -37.814, 144.963, 1000,
   'https://events.humanitix.com/rusu-members-drinks-rf55pmsj/tickets',
   'https://events.humanitix.com/rusu-members-drinks-rf55pmsj', 'humanitix',
   (select id from activity_types where label = 'Social mixers')),
  ((select id from clubs where name = 'Monash Student Association'),
   'MSA''s Free Food Mondays: Semester 2 week 7',
   'Free food at Wholefoods Cafe from the Monash Student Association.',
   'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F1189445533%2F230782431288%2F1%2Foriginal.20260723-030600?crop=focalpoint&fit=crop&w=940&auto=format%2Ccompress&q=75&sharp=10&fp-x=0.5&fp-y=0.5&s=a9e746158fbd01f562247438daf14593',
   '2026-09-07 07:00:00+00', '2026-09-07 08:30:00+00', 'Wholefoods Cafe & Restaurant', 'Clayton',
   'Level 1, 21 Chancellors Walk, Monash University VIC 3800', -37.917, 145.122, 0,
   'https://www.eventbrite.com.au/e/msas-free-food-mondays-semester-2-week-7-expression-of-interest-only-tickets-1994915433764',
   'https://www.eventbrite.com.au/e/msas-free-food-mondays-semester-2-week-7-expression-of-interest-only-tickets-1994915433764', 'eventbrite',
   (select id from activity_types where label = 'Food & cafés')),
  ((select id from clubs where name = 'Monash Student Association'),
   'LGBTeas - Semester 2 (week 7)',
   'A weekly morning tea in the Queer Lounge for queer and questioning students.',
  'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F1189281109%2F230782431288%2F1%2Foriginal.20260721-062913?crop=focalpoint&fit=crop&w=940&auto=format%2Ccompress&q=75&sharp=10&fp-x=0.5&fp-y=0.5&s=491a8bd4b6754da84103fea57bb9e034',
   '2026-09-08 01:00:00+00', '2026-09-08 03:00:00+00', 'The Queer Lounge', 'Clayton',
   '21 Chancellors Walk, Clayton VIC 3168', -37.917, 145.122, 0,
   'https://www.eventbrite.com.au/e/lgbteas-semester-2-week-7-tickets-1994643851454',
   'https://www.eventbrite.com.au/e/lgbteas-semester-2-week-7-tickets-1994643851454', 'eventbrite',
   (select id from activity_types where label = 'Social mixers')),
  ((select id from clubs where name = 'Monash Student Association'),
   'Wednesday Sessions week 7 ~ The Grogans',
   'The Grogans and Waldie Lane at Wednesday Sessions.',
   'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F1189279737%2F230782431288%2F1%2Foriginal.20260721-053742?crop=focalpoint&fit=crop&w=940&auto=format%2Ccompress&q=75&sharp=10&fp-x=0.5&fp-y=0.5&s=e920dd40f54fbd0280c7790975a98595',
   '2026-09-09 06:00:00+00', '2026-09-09 08:00:00+00', 'Monash University Lemon Scented Lawn', 'Clayton',
   'Sports Walk, Monash University, Clayton VIC 3800', -37.917, 145.122, 0,
   'https://www.eventbrite.com.au/e/wednesday-sessions-week-7-the-grogans-tickets-1994638697037',
   'https://www.eventbrite.com.au/e/wednesday-sessions-week-7-the-grogans-tickets-1994638697037', 'eventbrite',
   (select id from activity_types where label = 'Concerts & performances')),
  ((select id from clubs where name = 'Monash Student Association'),
   'MSA Mocktail Classes',
   'Shake up your week with an MSA mocktail class.',
   'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F1191691934%2F183331893437%2F1%2Foriginal.20260823-105716?w=940&auto=format%2Ccompress&q=75&sharp=10&q=75&s=097f0d291e6e4700bfa58a77ad92bb14',
   '2026-09-09 08:00:00+00', '2026-10-07 10:00:00+00', 'Monash University Clayton Campus', 'Clayton',
   'Wellington Road, Clayton VIC 3800', -37.917, 145.122, 1020,
   'https://www.eventbrite.com.au/e/msa-mocktail-classes-tickets-1998667243528',
   'https://www.eventbrite.com.au/e/msa-mocktail-classes-tickets-1998667243528', 'eventbrite',
   (select id from activity_types where label = 'Food & cafés')),
  ((select id from clubs where name = 'Monash Student Association'),
   'Queer Beers Semester 2 (week 7)',
   'Free cider, soft drinks and chips for queer and questioning students.',
   'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F1189440523%2F230782431288%2F1%2Foriginal.20260723-011834?w=940&auto=format%2Ccompress&q=75&sharp=10&s=52ce9a8b2ec8fdcd337e50f751a53d5f',
   '2026-09-10 05:00:00+00', '2026-09-10 07:00:00+00', 'Sir John''s', 'Clayton',
   '21 Chancellors Walk, Clayton VIC 3168', -37.917, 145.122, 0,
   'https://www.eventbrite.com.au/e/queer-beers-semester-2-week-7-tickets-1994913326461',
   'https://www.eventbrite.com.au/e/queer-beers-semester-2-week-7-tickets-1994913326461', 'eventbrite',
   (select id from activity_types where label = 'Social mixers')),
  ((select id from clubs where name = 'Monash Student Association'),
   'MSA Free Auslan Workshop week 7 (morning)',
   'A free casual beginner Auslan class.',
   'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F1190248531%2F230782431288%2F1%2Foriginal.20260804-015049?w=940&auto=format%2Ccompress&q=75&sharp=10&fp-x=0.5&fp-y=0.5&s=dee3083ab26bd2816dbbb1cef6460630',
   '2026-09-11 10:00:00+00', '2026-09-11 12:00:00+00', 'Learning & Teaching Building LTB 303', 'Clayton',
   '19 Ancora Imparo Wy, Clayton VIC 3800', -37.917, 145.122, 0,
   'https://www.eventbrite.com.au/e/msa-free-auslan-workshop-week-7-morning-tickets-1996533962828',
   'https://www.eventbrite.com.au/e/msa-free-auslan-workshop-week-7-morning-tickets-1996533962828', 'eventbrite',
   (select id from activity_types where label = 'Culture & languages')),
  ((select id from clubs where name = 'Monash Student Association'),
   'MSA Free Auslan Workshop week 7 (afternoon)',
   'A free casual beginners Auslan class.',
   'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F1190248531%2F230782431288%2F1%2Foriginal.20260804-015049?w=940&auto=format%2Ccompress&q=75&sharp=10&fp-x=0.5&fp-y=0.5&s=dee3083ab26bd2816dbbb1cef6460630',
   '2026-09-11 14:00:00+00', '2026-09-11 16:00:00+00', 'Learning & Teaching Building LTB 303', 'Clayton',
   '19 Ancora Imparo Wy, Clayton VIC 3800', -37.917, 145.122, 0,
   'https://www.eventbrite.com.au/e/msa-free-auslan-workshop-week-7-afternoon-tickets-1996533979879',
   'https://www.eventbrite.com.au/e/msa-free-auslan-workshop-week-7-afternoon-tickets-1996533979879', 'eventbrite',
   (select id from activity_types where label = 'Culture & languages'));
insert into events (club_id, title, description, starts_at, ends_at, venue_name, suburb, address,
                    lat, lng, price_cents, ticket_url, ticket_provider, activity_type_id) values (
  (select id from clubs where name = 'Melbourne University Computing Club'),
